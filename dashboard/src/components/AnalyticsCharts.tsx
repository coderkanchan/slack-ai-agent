      ...
      <div className="bg-slate-900/30 border border-slate-800/80 rounded-xl p-6 font-mono flex flex-col justify-between">
        ...
        <div className="h-44 flex items-end justify-around gap-6 border-b border-slate-800/60 pb-2 px-6">
          ...
          <div className="flex flex-col items-center gap-2 w-16 h-full justify-end group">
            ...
            <div
              style={{ height: hTotal }}
              className="w-full bg-gradient-to-t from-emerald-500/10 to-emerald-400/90 border-t border-emerald-400 rounded-t-[3px] transition-all duration-500 min-h-[10px]"
            ></div>
          ...
          <div className="flex flex-col items-center gap-2 w-16 h-full justify-end group">
            ...
            <div
              ...
              className="w-full bg-gradient-to-t from-amber-500/10 to-amber-400/90 border-t border-amber-400 rounded-t-[3px] transition-all duration-500 min-h-[10px]"
            ></div>
