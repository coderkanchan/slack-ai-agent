...
export const AnalyticsCharts: React.FC<AnalyticsChartsProps> = ({ rawData }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-w-0 w-full">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 font-mono flex flex-col justify-between shadow-xl min-w-0">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 font-mono shadow-xl min-w-0">
        <h3 className="text-xs font-bold tracking-wider text-slate-400 uppercase mb-6 flex items-center gap-2">
